...
const Likeicon = ({liked,count}) => {
  ...
  return (
    ...
    <div className="con-like">
      <input className="like" type="checkbox" title="like" checked={liked} onChange={handleLikeClick} />
      <div className="checkmark">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="filled" viewBox="0 0 24 24" style={{ display: liked ? 'block' : 'none' }}>
          <path d="M17.5,1.917a6.4,6.4,0,0,0-5.5,3.3,6.4,6.4,0,0,0-5.5-3.3A6.8,6.8,0,0,0,0,8.967c0,4.547,4.786,9.513,8.8,12.88a4.974,4.974,0,0,0,6.4,0C19.214,18.48,24,13.514,24,8.967A6.8,6.8,0,0,0,17.5,1.917Z"></path>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" height="100" width="100" className="celebrate" style={{ display: isLiked ? 'block' : 'none' }}>
    ...
    <div><span className="count">{count} Likes</span></div>
     </div>
  )
}
